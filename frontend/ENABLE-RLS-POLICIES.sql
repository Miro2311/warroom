...
-- Run this to make the system production-ready
-- ============================================================
...
CREATE POLICY "Users can view red flags in their groups"
...
CREATE POLICY "Users can create red flags in their groups"
...
-- Partner owners can delete red flags on their partners
CREATE POLICY "Users can delete red flags for their partners"
ON public.partner_red_flags FOR DELETE
USING (
  partner_id IN (
    SELECT id FROM public.partners WHERE user_id = auth.uid()
...
CREATE POLICY "Users can view ratings in their groups"
...
CREATE POLICY "Users can create ratings in their groups"
...
CREATE POLICY "Users can view timeline events in their groups"
...
CREATE POLICY "Users can create timeline events for their partners"
...
CREATE POLICY "Users can delete timeline events for their partners"
...
BEGIN
  ...
  RAISE NOTICE '- Users see only partners in THEIR groups';
  RAISE NOTICE '- Users can ONLY edit/delete THEIR OWN partners';
  RAISE NOTICE '- Intel tab (notes/flags/ratings): ALL group members can add';
  RAISE NOTICE '- Intel tab delete: Only AUTHOR can delete their own content';
  RAISE NOTICE '- Red flags: AUTHOR or PARTNER OWNER can delete';
